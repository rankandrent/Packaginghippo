...
export default function QuotePage() {
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Premium Hero Header */}
            <div className="bg-[#011f7b] pt-32 pb-20 md:pt-40 md:pb-32 text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-[#DAA520]/10 to-transparent pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#DAA520]/50 to-transparent" />

                <div className="container mx-auto px-4 relative z-10">
                    <div className="container mx-auto text-center space-y-6">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#DAA520] text-[#011f7b] text-xs font-black uppercase tracking-widest mb-4">
                            Premium Packaging Solutions
                        </div>
                        <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6 text-white">
                            Tailored Packaging <br /> <span className="text-[#DAA520]">Fast & Affordable</span>
                        </h1>
                ...
                <div className="max-w-6xl mx-auto grid lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-8 lg:pt-24">
                        <div className="space-y-6 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                            <h3 className="text-lg font-black uppercase tracking-tight text-[#011f7b] border-b pb-4">Why Packaging Hippo?</h3>

                            <div className="flex gap-4 items-start">
                                <div className="p-2 bg-blue-50 rounded-lg text-[#011f7b] shrink-0">
                            ...
                            <div className="flex gap-4 items-start">
                                <div className="p-2 bg-[#DAA520]/10 rounded-lg text-[#c4901a] shrink-0">
                        ...
                        <div className="bg-[#011f7b] p-8 rounded-2xl shadow-xl text-white space-y-4">
                            <div className="flex items-center gap-1 mb-2">
                                {[1, 2, 3, 4, 5].map(i => <div key={i} className="w-4 h-4 text-[#DAA520] fill-[#DAA520]">★</div>)}
                            </div>
                            ...
                            <div className="flex items-center gap-3 border-t border-white/10 pt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-white/60">CEO, TechStore Inc.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 px-2">
                            {["No Hidden Dies or Plate Charges", "Instant Proof Verification", "Free Design Support", "Eco-Friendly Materials"].map(item => (
                                <div key={item} className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-gray-400">
                                    <CheckCircle2 className="w-3.5 h-3.5 text-[#011f7b]" />
                                    {item}
                                </div>
                            ))}
                        </div>

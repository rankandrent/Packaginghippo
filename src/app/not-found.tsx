            ...
            <div className="max-w-md w-full text-center space-y-8">
                <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <h2 className="text-3xl font-black text-blue-900">Page Not Found</h2>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <Link
                        href="/"
                        className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-blue-900 text-white font-bold rounded-lg hover:bg-blue-800 transition-all"
                    >
                    ...
                    <Link
                        href="/products"
                        className="flex-1 flex items-center justify-center gap-2 px-6 py-3 border-2 border-blue-900 text-blue-900 font-bold rounded-lg hover:bg-blue-50 transition-all"
                    >
                ...
                <div className="pt-8 border-t">
                    <p className="text-sm font-bold text-gray-400 tracking-widest mb-4">Popular Categories</p>

            ...
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <Badge className="mb-4 bg-blue-100 text-[#01154f] hover:bg-blue-100 border-none px-4 py-1">OUR BLOG</Badge>
                        <h1 className="text-4xl md:text-6xl font-black text-[#011f7b] mb-6 tracking-tight">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-16">
                        <Link
                            ...
                            className={cn(
                                ...
                                !category ? "bg-[#011f7b] text-white border-[#011f7b] shadow-lg shadow-[#011f7b]/20" : "bg-white text-gray-500 border-gray-200 hover:border-[#011f7b] hover:text-[#011f7b]"
                            )}
                        >
                            All Posts
                        </Link>
                        {categories.map((cat: any) => (
                            <Link
                                ...
                                className={cn(
                                    "px-6 py-2 rounded-full text-sm font-bold transition-all border",
                                    category === cat.slug ? "bg-[#011f7b] text-white border-[#011f7b] shadow-lg shadow-[#011f7b]/20" : "bg-white text-gray-500 border-gray-200 hover:border-[#011f7b] hover:text-[#011f7b]"
                                )}
                            >
                                {cat.name}
                            </Link>
                            ...
                            <div className="grid lg:grid-cols-2 gap-0 bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100 min-h-[450px]">
                                <div className="relative overflow-hidden aspect-video lg:aspect-auto bg-gray-100">
                                    ...
                                    <div className="absolute top-6 left-6">
                                        <Badge className="bg-[#DAA520] text-[#212529] border-none font-black uppercase">Featured</Badge>
                                    </div>
                                </div>
                                <div className="p-8 md:p-12 flex flex-col justify-center">
                                    ...
                                    <h2 className="text-3xl md:text-4xl font-black text-[#011f7b] mb-6 group-hover:text-[#01154f] transition-colors leading-tight">
                                        {featuredPost.title}
                                    </h2>
                                    ...
                                    <div className="flex items-center text-[#011f7b] font-black uppercase tracking-wider text-sm">
                        ...
                        {remainingPosts.map((post: any) => (
                            <Link key={post.id} href={`/blog/${post.slug}`} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-gray-100 flex flex-col">
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    ...
                                    <h2 className="text-xl font-black text-[#011f7b] mb-4 group-hover:text-[#01154f] transition-colors line-clamp-2 leading-snug">
                                        {post.title}
                                    </h2>
                    ...
                    {posts.length === 0 && (
                        <div className="text-center py-20 bg-white rounded-3xl border border-dashed text-gray-400">
                            ...
                            <Link href="/blog" className="text-[#011f7b] underline mt-4 inline-block font-bold">View all posts</Link>
                        </div>
                    )}
                </div>
            </div>

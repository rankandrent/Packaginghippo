                                ...
                                <div className="grid gap-3 md:grid-cols-3">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            step="0.1"
                                            min="0"
                                            value={category.ratingValue ?? ""}
                                            onChange={(e) => setCategory({ ...category, ratingValue: e.target.value === "" ? null : parseFloat(e.target.value) })}
                                            placeholder="4.9"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            step="0.1"
                                            min="1"
                                            value={category.bestRating ?? ""}
                                            onChange={(e) => setCategory({ ...category, bestRating: e.target.value === "" ? null : parseFloat(e.target.value) })}
                                            placeholder="5"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            type="number"
                                            min="1"
                                            value={category.ratingCount ?? ""}
                                            onChange={(e) => setCategory({ ...category, ratingCount: e.target.value === "" ? null : parseInt(e.target.value, 10) })}
                                            placeholder="101"
                                        />
                                    </div>
                                </div>

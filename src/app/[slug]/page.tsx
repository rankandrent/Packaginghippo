        ...
        switch (id) {
            case 'content':
                return category.description && (
                    <section key="content" className="section-py bg-white border-t border-gray-100">
                        <div className="container mx-auto px-4">
                            <div className="prose max-w-none text-[#212529] leading-relaxed rich-text">
                                <h2 className="text-3xl font-bold mb-8 text-[#011f7b]">{category.name} Overview</h2>
            ...
            case 'content':
                return product.description && !sections.find(s => s.type === 'text') && (
                    <section key="content" className="section-py bg-white border-t border-gray-100">
                        <div className="container mx-auto px-4">
                            <div className="prose max-w-none text-[#212529] leading-relaxed rich-text">
                                <h2 className="text-3xl font-bold mb-8 text-[#011f7b]">Product Overview</h2>
                                <CollapsibleText
                    ...
                    <div className="grid lg:grid-cols-12 gap-10 items-start">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-100">
                                <div className="flex-1 bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] font-bold text-[#212529] tracking-tight">Google Business Review 5.0</span>
                                    </div>
                                </div>
                                <div className="flex-1 bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] font-bold text-[#212529] tracking-tight">Trustpilot Excellent</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            <div className="space-y-4">
                                <div>
                                    {product.category && <span className="brand-eyebrow mb-2">{product.category.name}</span>}
                                    <h1 className="text-3xl md:text-5xl font-black text-[#011f7b] leading-[1.1] tracking-tight">{product.name}</h1>
                                </div>

                                {product.isEcommerce && product.ecommercePrice ? (
                                    <div className="flex items-baseline gap-2 mb-4">
                                        <span className="text-4xl font-black text-[#011f7b]">${product.ecommercePrice.toFixed(2)}</span>
                                ...
                                <div className="flex flex-wrap gap-3 mb-4">
                                    {[
                                        ...
                                        { icon: "🎁", label: "Free of Charge" },
                                            ...
                                            <div key={label} className="flex items-center gap-1.5 bg-[#011f7b]/5 border border-[#011f7b]/10 rounded-full px-3 py-1.5">
                                                <span className="text-sm">{icon}</span>
                                                <span className="text-xs font-bold text-[#011f7b]">{label}</span>
                                            </div>
                                        ))}
                                    </div>
                                )}
                                ...
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 italic text-xs text-gray-500 flex items-center gap-2">
                                    <Info className="w-4 h-4 text-[#011f7b] flex-shrink-0" />
...
async function PageView({ page, slug }: { page: any, slug: string }) {
    ...
    return (
        <main className="min-h-screen bg-[#F8F9FA]">
            ...
            {/* Header Area — navy brand hero */}
            <div className="relative overflow-hidden bg-[#011f7b] pt-32 pb-16 md:pt-40 md:pb-20">
            ...
            {sections.length === 0 && htmlContent && (
                <div className="bg-white py-16 md:py-20 border-t border-gray-100">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto prose prose-lg max-w-none text-[#212529] leading-relaxed rich-text">

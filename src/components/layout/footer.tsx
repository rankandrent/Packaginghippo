                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link href="/gift-boxes" className="text-white/80 hover:text-white transition-colors">Gift Boxes</Link></li>
                            <li><Link href="/custom-rigid-boxes" className="text-white/80 hover:text-white transition-colors">Custom Rigid Boxes</Link></li>
                            <li><Link href="/eco-friendly-packaging" className="text-white/80 hover:text-white transition-colors">Eco Friendly Packaging</Link></li>
                            <li><Link href="/retail-boxes" className="text-white/80 hover:text-white transition-colors">Retail Boxes</Link></li>
                        </ul>
                    </div>

            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {data.items?.map((ind: string, i: number) => (
                        <div key={i} className="px-6 py-4 bg-gray-50 rounded-xl text-lg font-bold text-[#212529] border hover:border-[#DAA520] hover:bg-[#DAA520]/10 transition-all cursor-default">
                            {ind}
                        </div>
                    ))}
                </div>
